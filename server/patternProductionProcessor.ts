    ...
    messages: [
      {
        ...
        content: [
          ...
          "10. ADD ONLY THE NICHE HOOK, never non-niche junk. The conversion itself MAY add what makes the design read as the niche — a niche pun/text, or a niche prop/activity for a swapped mascot (a paddle, the court, a dinking pose); that is REQUIRED, not invented junk. What stays BANNED is anything that is NOT the niche hook: wine glasses, drinks, sparkles, banners, frames, 'lifestyle' flourishes, or extra balls/paddles beyond what the hook needs. PO-flagged failure: a T-Rex tee got a random wine glass added — that is a hard FAIL. When in doubt, change LESS.",
